    ...
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Nenhum item na venda. Bipe um código para começar.
        </p>
      ...
      <table className="w-full text-sm">
        <thead className="sticky top-0 z-10 bg-card">
          <tr className="border-b border-border text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
            <th scope="col" className="w-12 px-5 py-2.5 text-left font-semibold">
              #
            </th>
              ...
              >
                ...
                <td className="px-2 py-3">
                  ...
                  <div className="mt-0.5 font-mono text-[11px] text-muted-foreground">
                    ...
                    <span className={cn(semEstoque && "font-semibold text-destructive")}>
                ...
                <td
                  ...
                  title={semEstoque ? "Quantidade acima do estoque" : undefined}
                >
